...
public class SchoolServiceApplication {
    public static void main(String[] args) {
        SpringApplication.run(com.example.SchoolServiceApplication.class, args);
    }
    ...
    public String checkLabelRefresh() throws JsonProcessingException
    {
        return getLabelProperties();
    }

    @GetMapping(value = "/properties", produces = "application/json; charset=UTF-8")
    public String getLabelProperties() throws JsonProcessingException
    {
