...
@Component
public class ListenerProducer implements RabbitListener<Message> {
    private static final Logger LOGGER = LoggerFactory.getLogger(ListenerProducer.class);
    ...
    public void receiveMessage(Message message) {
        ...
        try {
            ...
            publisher.publishProducer(message);
